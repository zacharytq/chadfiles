...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["telekasten.nvim"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/telekasten.nvim",
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
